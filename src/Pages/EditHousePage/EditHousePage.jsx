...
const EditHousePage = () =>{
    ...
    const [toilet,setToilet] = useState(postData.bathroom);
    const [floor,setFloor] = useState(postData.floors);
    ...
    const handleSubmit = async (e) =>{
        ...
        const result = await api.call(endpoints.editHouse,editConfig);
   ...
   {postData &&(
        ...
        <Button onClick={()=>navigate(`/houses/${postId}`)}>
            Submit
        </Button>
        </> )}
        </div>
