...
const Query = ({submit}) =>{
  const navigate = useNavigate();
    ...
    const handleSubmit = async(e)=>{
        ...
        if(navigateData[1]==='Lagjja'){
            navigateData = [navigateData[0],null,status,type,rooms,bathrooms];
        }
        if(navigateData[2]==='Statusi'){
            navigateData = [navigateData[0],navigateData[1],type,rooms,bathrooms];
        }
