...
const PromotedLokal = () =>{
    ...
    useEffect(()=>{
        const getApartments = async ()=>{
            const result = await api.call(endpoints.getPromotedLokal);
    ...
    return <>
        <div className="wrapper-heading" onClick={()=>{navigate('/lokale')}}>
